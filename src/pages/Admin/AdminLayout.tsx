...
export const SECTIONS = [
  ...
  { id: 'campus-life',    icon: '🌳', label: 'Campus Life' },
  ...
  { id: 'annual-reports', icon: '🗂️', label: 'Annual Reports & Reforms' },
  { id: 'nirf-reports',   icon: '📈', label: 'NIRF Reports' },
  { id: 'nba-data',       icon: '📊', label: 'NBA Data Capturing Points' },
  { id: 'differentiators', icon: '✨', label: 'Differentiators' },
  { id: 'placement-items', icon: '📈', label: 'Placement Sub-pages' },
  { id: 'tpo-team-info', icon: '📝', label: 'TPO Team Info' },
  { id: 'placement-crt-docs', icon: '🗓️', label: 'CRT Timetables' },
  { id: 'tpo-team-photos', icon: '🪪', label: 'TPO Team Photos' },
  { id: 'ilo-office-photos', icon: '🏢', label: 'Industry Liaison Office Photos' },
  { id: 'recruiter-logos', icon: '🏷️', label: 'Recruiter Logos' },
...
export const SECTION_GROUPS: { label: string; ids: string[] }[] = [
  ...
  { label: 'Placements & Careers', ids: ['placements', 'placement-items', 'tpo-team-info', 'placement-crt-docs', 'tpo-team-photos', 'ilo-office-photos', 'recruiter-logos', 'gsac-photos'] },

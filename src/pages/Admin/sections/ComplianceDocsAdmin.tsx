    ...
    <div className="admin-section">
      <div className="admin-card">
        ...
        <p className="admin-lead" style={{ marginBottom: '1rem' }}>
          ...
          RTI, Facilities for Persons with Disabilities, and UGC Public Self-Disclosure itself) are also linked

    ...
    <div className="admin-section">
      <div className="admin-card">
        ...
        <div className="admin-form-grid">
          ...
          <div className="admin-field admin-field--full">
            <label htmlFor="field-about-longer-detail-paragraph-optional">About (longer detail paragraph — optional)</label>
            <textarea id="field-about-longer-detail-paragraph-optional" rows={4} value={form.about} onChange={(e) => set('about', e.target.value)} />
          </div>
          <div className="admin-field admin-field--full">

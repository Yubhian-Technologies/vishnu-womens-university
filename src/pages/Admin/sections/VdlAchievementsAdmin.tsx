...
const EMPTY: Omit<VdlAchievementReportDoc, 'id'> = { label: '', fileUrl: '', storagePath: '', order: 0 };
    ...
    <div className="admin-section">
      <div className="admin-card">
        ...
        <p className="admin-lead" style={{ marginBottom: '1rem' }}>
          Powers the "Achievements" report links on the Vehicle Design Lab page's Placements section.
        </p>

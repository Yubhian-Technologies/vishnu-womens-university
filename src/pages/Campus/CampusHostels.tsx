...
const admissionProcedureRules: string[] = [
  ...
  'Students suffering from contagious diseases / drug addicts are not eligible for admission. If after admission students, found to be having contagious diseases and drug addicts, shall be sent out of the Hostel immediately. He /she is eligible for refund of money as per Rule No.9 of Admission.',
...
const disciplinePolicyRules: string[] = [
  ...
  'Defacing the walls or the doors should be avoided. Any willful damage done to the property of the Hostel by boarder will entail for his / her dismissal from the Hostel along with a minimum fine of Rs.500/- (Rupees Five Hundred Only).',

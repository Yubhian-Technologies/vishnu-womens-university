  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        For recruitment, industry engagement and placement-related enquiries:
      </p>
      <div style={{
        display: 'flex',
        alignItems: 'center',
        ...
        {(emails || []).map((email, ei) => (
          ...
          >
            <span style={{ color: 'var(--color-text-light)', fontWeight: 400 }}>Email:</span>
            {email}
          </a>
        ))}
        {(linkedins || []).map((url, li) => (
          ...
          >
            <span style={{ color: 'var(--color-text-light)', fontWeight: 400 }}>LinkedIn:</span>
            View Profile →
          </a>
        ))}
      </div>
...
export default function PlacementDetail() {
  ...
  const showOutcomes = activeOutcomes.length > 0 && item.slug !== 'placement-highlights' && item.slug !== 'our-recruiters' && item.slug !== 'tpo-team' && item.slug !== 'industry-liaison-offices' && item.slug !== 'career-guidance-cell';

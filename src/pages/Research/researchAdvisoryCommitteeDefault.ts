...
export const DEFAULT_RAC_INTRO = `The Research Advisory Committee (RAC) at Shri Vishnu Engineering College for Women (A) (Vishnu Women's University), Bhimavaram is a pivotal body dedicated to fostering and enhancing research endeavors across various disciplines. Recognizing the significance of research in academic excellence and societal advancement and impact, the RAC plays a vital role in guiding, supporting, and promoting research activities within our institution.`;

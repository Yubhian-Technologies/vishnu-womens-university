...
interface Props {
  /** Replaces the target textarea's value with the imported pipe-delimited text. */
...
export default function TableImportButton({ onImport, label = 'Import from Excel/CSV' }: Props) {

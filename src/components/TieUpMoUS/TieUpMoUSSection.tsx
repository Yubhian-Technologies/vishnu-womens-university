...
export default function TieUpMoUSSection() {
  ...
  return (
    <section className="recruiters-home-section" aria-label="Tie-Ups and MoUs">
      <div className="container">
        {/* Section Header */}
        <div className="recruiters-home-header reveal">
          <div className="recruiters-header-text">
            <h2 className="section-title gradient-text">Tie-Ups &amp; MoUs</h2>
            <p className="section-desc">
              Collaborative partnerships with industry leaders and academic institutions.
            </p>
          </div>

          <Link to="/research/mous" className="btn btn-outline recruiters-view-all-btn">
            <span>View All Tie-Ups</span>

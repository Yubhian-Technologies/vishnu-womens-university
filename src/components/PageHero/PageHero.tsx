...
interface PageHeroProps {
  ...
  hideCta?: boolean;
  /** 'split' renders text on a solid navy panel beside a separate rounded
...
export default function PageHero({
  ...
  const navMarkup = allSlides.length > 1 && (
    <>
    ...
    <section className={`page-hero page-hero--${size}`}>
      <div className="container">
        ...
        >
          {layout === 'split' ? (
            <>
              <div className="page-hero-split-image">{slidesMarkup}</div>

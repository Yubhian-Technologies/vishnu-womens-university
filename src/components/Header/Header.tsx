...
const navItemsData: NavItem[] = [
  ...
  },
  {
    ...
    // (Sewage Treatment Plants, Wellness), the five Student Activities
...
export default function Header() {
  ...
  // Clubs, the Student Activities pages, ...) — admin-editable via Admin ->
  // Campus Life -> "Campus Life Menu — Other Links". Falls back to the
  // original hardcoded list (still declared in navItemsData below, for
  // isEnabledNavPath's static scan) while that collection is loading or
  // empty, so removing this admin section's data can never blank the menu.

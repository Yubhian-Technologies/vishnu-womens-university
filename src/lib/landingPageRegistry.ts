...
export const LANDING_PAGE_REGISTRY: LandingPageRegistryEntry[] = [
  ...
  },
  {
    ...
    imageSlots: [
      ...
      { key: 'research-story-1', label: 'Featured Research — Story 1 Photo (Thrust Areas of Research)', defaultUrl: PHOTO_NEEDED_PLACEHOLDER, aspect: 4 / 3 },
      { key: 'research-story-2', label: 'Featured Research — Story 2 Photo (Funded Projects)', defaultUrl: PHOTO_NEEDED_PLACEHOLDER, aspect: 4 / 3 },
      { key: 'research-story-3', label: 'Featured Research — Story 3 Photo (Seed Money Projects)', defaultUrl: PHOTO_NEEDED_PLACEHOLDER, aspect: 4 / 3 },
